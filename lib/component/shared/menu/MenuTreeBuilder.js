...
class MenuTreeBuilder {
    build(menus, parent) {
        const lis = parent === undefined ? [] : [(0, skydapp_browser_1.el)("li.parent", (0, skydapp_browser_1.el)(`a${location.pathname === `/${parent.uri}` ? ".on" : ""}`, (0, skydapp_browser_1.msg)(parent.key), {
        ...
        for (const menuItem of menus) {
            const li = (0, skydapp_browser_1.el)("li", (0, skydapp_browser_1.el)(`a${location.pathname === `/${menuItem.uri}` ? ".on" : ""}`, (0, skydapp_browser_1.msg)(menuItem.key), {
