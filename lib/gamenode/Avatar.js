...
class Avatar extends skydapp_browser_1.GameNode {
    constructor(info) {
        ...
        if (info.avatarId === Sigor_1.default.currentUserInfo?.avatarId) {
    ...
    makeSpriteNode(setImage, sprite) {
        ...
        if (image !== undefined) {
            ...
            node.on("load", () => {
                ...
                const shadow = new skydapp_browser_1.CircleNode(0, 0, width * this.originalScale, width * this.originalScale / 2, 0x000000).appendTo(this);
                shadow.alpha = 0.05;
                this.statesNode.z = 1;
            });
            return node;
    ...
    showMessage(message) {
        if (this.messageBalloon !== undefined) {
            ...
            this.messageBalloon = new MessageBalloon_1.default(-this.height * this.originalScale).appendTo(this);
            this.messageBalloon.updateMessage(message);
